        ...
        for identifier in sorted_identifiers {
            ...
            while let Some(source) = sources.pop() {
                ...
                for successor in successors {
                    ...
                    subgraph_edges
                        .push((source.index() as DefaultIx, successor.index() as DefaultIx)); // NOTE: will this work, if nodes contain actual data?
                ...
                for predecessor in graph.neighbors_directed(source, Direction::Incoming) {
                    ...
                    subgraph_edges.push((
                        predecessor.index() as DefaultIx,
                        source.index() as DefaultIx,
                    ));
